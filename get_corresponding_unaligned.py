...
def get_corresponding_unaligned(params):
    ...
    print(f"Final NANOBODY barcode library count: {final_nb_count}")
    print(f"Final ISH PROBE barcode library count: {final_probe_count}")
...
def main():
    ...
    get_corresponding_unaligned(params)
