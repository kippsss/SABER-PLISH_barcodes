...
def assign_nb_probe_bc(params):
    ...
    sequences with highest complexity to nanobody barcode and ISH probe barcode pools.""")
    ...
    with open(params.get("nb_output_filepath"), "w") as nb_output_filepath:
        for nb_bc in nb_bc_list:
            ...
            nb_bc_count += 1
    print(f"{nb_bc_count} sequences has been assigned to nanobody barcode pool.")
    ...
    with open(params.get("probe_output_filepath"), "w") as probe_output_filepath:
        for probe_bc in probe_bc_list:
            ...
            probe_bc_count += 1
    print(f"{probe_bc_count} sequences has been assigned to ISH probe barcode pool.")
